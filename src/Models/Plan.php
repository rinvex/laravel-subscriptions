...
class Plan extends Model implements Sortable
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setRules([
            ...
            'trial_period' => 'sometimes|required|integer',
            'trial_interval' => 'sometimes|required|in:d,w,m,y',
            'invoice_period' => 'sometimes|required|integer',
            'invoice_interval' => 'sometimes|required|in:d,w,m,y',
            'grace_period' => 'sometimes|required|integer',
            'grace_interval' => 'sometimes|required|in:d,w,m,y',
